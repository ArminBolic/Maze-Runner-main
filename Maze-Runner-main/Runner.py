...
class Obstacles(Player):
    ...
    def __init__(self):
        ...
        self.fire_spell_rect_back = pygame.Rect(self.rect_surface_image.x - 20, self.rect_surface_image.y + 30, 64,
                                                64)
        self.boxtop = pygame.image.load("images/White.png")
        self.boxtop = pygame.transform.scale(self.boxtop, (60, 10))
        self.boxtop_rect = pygame.Rect(self.rect_box.x, self.rect_box.y , 30, 10)
        self.boxbottom = pygame.image.load("images/White.png")
        self.boxbottom = pygame.transform.scale(self.boxbottom, (60, 10))
        self.boxbottom_rect = pygame.Rect(self.rect_box.x, self.rect_box.y + 48, 30, 20)
        self.boxleft = pygame.image.load("images/White.png")
        self.boxleft = pygame.transform.scale(self.boxleft, (1, 40))
        self.boxleft_rect = pygame.Rect(self.rect_box.x - 5, self.rect_box.y  + 20, 10, 30)
        self.boxtop1 = pygame.image.load("images/White.png")
        self.boxtop1 = pygame.transform.scale(self.boxtop1, (60, 10))
        self.boxtop1_rect = pygame.Rect(self.rect_box1.x, self.rect_box1.y, 30, 10)
        self.boxbottom1 = pygame.image.load("images/White.png")
        self.boxbottom1 = pygame.transform.scale(self.boxbottom1, (60, 10))
        self.boxbottom1_rect = pygame.Rect(self.rect_box1.x, self.rect_box1.y + 48, 30, 20)
        self.boxleft1 = pygame.image.load("images/White.png")
        self.boxleft1 = pygame.transform.scale(self.boxleft1, (1, 40))
        self.boxleft1_rect = pygame.Rect(self.rect_box1.x - 5, self.rect_box1.y + 20, 10, 30)
        self.boxtop2 = pygame.image.load("images/White.png")
        self.boxtop2 = pygame.transform.scale(self.boxtop2, (60, 10))
        self.boxtop2_rect = pygame.Rect(self.rect_box2.x, self.rect_box2.y, 30, 10)
        self.boxbottom2 = pygame.image.load("images/White.png")
        self.boxbottom2 = pygame.transform.scale(self.boxbottom2, (60, 10))
        self.boxbottom2_rect = pygame.Rect(self.rect_box2.x, self.rect_box2.y + 48, 30, 20)
        self.boxleft2 = pygame.image.load("images/White.png")
        self.boxleft2 = pygame.transform.scale(self.boxleft2, (1, 40))
        self.boxleft2_rect = pygame.Rect(self.rect_box2.x - 5, self.rect_box2.y + 20, 10, 30)
        self.boxtop3 = pygame.image.load("images/White.png")
        self.boxtop3 = pygame.transform.scale(self.boxtop3, (60, 10))
        self.boxtop3_rect = pygame.Rect(self.rect_box3.x, self.rect_box3.y, 30, 10)
        self.boxbottom3 = pygame.image.load("images/White.png")
        self.boxbottom3 = pygame.transform.scale(self.boxbottom3, (60, 10))
        self.boxbottom3_rect = pygame.Rect(self.rect_box3.x, self.rect_box3.y + 48, 30, 20)
        self.boxleft3 = pygame.image.load("images/White.png")
        self.boxleft3 = pygame.transform.scale(self.boxleft3, (1, 40))
        self.boxleft3_rect = pygame.Rect(self.rect_box3.x - 5, self.rect_box3.y + 20, 10, 30)
        self.boxtop4 = pygame.image.load("images/White.png")
        self.boxtop4 = pygame.transform.scale(self.boxtop4, (60, 10))
        self.boxtop4_rect = pygame.Rect(self.rect_box4.x, self.rect_box4.y, 30, 10)
        self.boxbottom4 = pygame.image.load("images/White.png")
        self.boxbottom4 = pygame.transform.scale(self.boxbottom4, (60, 10))
        self.boxbottom4_rect = pygame.Rect(self.rect_box4.x, self.rect_box4.y + 48, 30, 20)
        self.boxleft4 = pygame.image.load("images/White.png")
        self.boxleft4 = pygame.transform.scale(self.boxleft4, (1, 40))
        self.boxleft4_rect = pygame.Rect(self.rect_box4.x - 5, self.rect_box4.y + 20, 10, 30)
    ...
    def obstacles_blits(self):
        ...
        screen.blit(self.boxbottom, self.boxbottom_rect)
        screen.blit(self.boxtop, self.boxtop_rect)
        screen.blit(self.boxleft, self.boxleft_rect)
        screen.blit(self.boxbottom1, self.boxbottom1_rect)
        screen.blit(self.boxtop1, self.boxtop1_rect)
        screen.blit(self.boxleft1, self.boxleft1_rect)
        screen.blit(self.boxbottom2, self.boxbottom2_rect)
        screen.blit(self.boxtop2, self.boxtop2_rect)
        screen.blit(self.boxleft2, self.boxleft2_rect)
        screen.blit(self.boxbottom3, self.boxbottom3_rect)
        screen.blit(self.boxtop3, self.boxtop3_rect)
        screen.blit(self.boxleft3, self.boxleft3_rect)
        screen.blit(self.boxbottom4, self.boxbottom4_rect)
        screen.blit(self.boxtop4, self.boxtop4_rect)
        screen.blit(self.boxleft4, self.boxleft4_rect)
    ...
    def box_movement(self):
        ...
        self.rect8_box3.x -= 6
        self.rect9_box4.x -= 6
        self.boxbottom_rect.x -= 6
        self.boxtop_rect.x -= 6
        self.boxleft_rect.x -= 6
        self.boxbottom1_rect.x -= 6
        self.boxtop1_rect.x -= 6
        self.boxleft1_rect.x -= 6
        self.boxbottom2_rect.x -= 6
        self.boxtop2_rect.x -= 6
        self.boxleft2_rect.x -= 6
        self.boxbottom3_rect.x -= 6
        self.boxtop3_rect.x -= 6
        self.boxleft3_rect.x -= 6
        self.boxbottom4_rect.x -= 6
        self.boxtop4_rect.x -= 6
        self.boxleft4_rect.x -= 6

        
        if self.rect_box.left < - 200:
            self.rect_box.right = 2000
            self.boxbottom_rect.x = 1960
            self.boxtop_rect.x = 1960
            self.boxleft_rect.x = 1955
        elif self.rect_box1.left < - 100:
            self.rect_box1.right = 2500
            self.boxbottom1_rect.x = 2440
            self.boxtop1_rect.x = 2440
            self.boxleft1_rect.x = 2435
        elif self.rect_box2.left < - 250:
            self.rect_box2.right = 3000
            self.boxbottom2_rect.x = 2960
            self.boxtop2_rect.x = 2960
            self.boxleft2_rect.x = 2955
        elif self.rect_box3.left < - 350:
            self.rect_box3.right = 3500
            self.boxbottom3_rect.x = 3460
            self.boxtop3_rect.x = 3460
            self.boxleft3_rect.x = 3455
        elif self.rect_box4.left < - 400:
            self.rect_box4.right = 4000
            self.boxbottom4_rect.x = 3960
            self.boxtop4_rect.x = 3960
            self.boxleft4_rect.x = 3955
    ...
    def colision(self):
        global game_active, move, spell, spell2, ice_spell_flag, fire_spell_flag, player_moving, froze
        global bgX
        global coins
        global menu_active
        ...
        if self.rect_surface_image.colliderect(self.boxtop_rect) or self.rect_surface_image.colliderect(self.boxtop1_rect) or self.rect_surface_image.colliderect(self.boxtop2_rect) or self.rect_surface_image.colliderect(self.boxtop3_rect) or self.rect_surface_image.colliderect(self.boxtop4_rect):
            self.rect_surface_image.top = 335
            self.player_gravity = 0

        if self.rect_surface_image.colliderect(self.boxbottom_rect) or self.rect_surface_image.colliderect(self.boxbottom1_rect) or self.rect_surface_image.colliderect(self.boxbottom2_rect) or self.rect_surface_image.colliderect(self.boxbottom3_rect) or self.rect_surface_image.colliderect(self.boxbottom4_rect):
            self.player_gravity += 20

        if self.rect_surface_image.colliderect(self.boxleft_rect) or self.rect_surface_image.colliderect(self.boxleft1_rect) or self.rect_surface_image.colliderect(self.boxleft2_rect) or self.rect_surface_image.colliderect(self.boxleft3_rect) or self.rect_surface_image.colliderect(self.boxleft4_rect):
            player_moving = False
        else:
            if froze == 0:
                player_moving = True
